...
function unpack (pkg, ver, unpackTarget, dMode, fMode, uid, gid, cb) {
  ...
  read(pkg, ver, false, function (er, data) {
	...
	if( data.repository &&  data.repository.type && data.repository.type.toLowerCase()=='git' && data.repository.url && npm.config.repo.asWorkdir(pkg) ){
